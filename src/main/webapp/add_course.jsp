                    ...
                    <div class="relative mt-1 block text-center">
                        <a href="Home.jsp">
                            <h1 class="font-extrabold text-5xl text-violet-600">
										Add New Course<span class="text-red-500">.</span>
                            </h1>
                        </a>
                    </div>

                    <!-- Form -->
                    <form class="my-5 max-w-[400px] mx-auto" action="AddCourse" method="post"
                        ...
                        <!-- Email -->
                          <label class="label">
						    ...
						    <input name="course_title" type="text" class="input input-bordered w-full" required />
						
						    <!-- Start Date -->
						    <label class="label">
						        <span class="label-text">Start Date</span>
						    </label>
						    <input name="start_date" type="date" class="input input-bordered w-full" required />
						
						    <!-- Brief Description -->
						    <label class="label">
						        <span class="label-text">Brief Description</span>
						    </label>
						    <textarea name="brief_description" class="textarea textarea-bordered w-full" rows="4" required></textarea>
						
						    <!-- Course Code -->
						    <label class="label">
						        <span class="label-text">Course Code</span>
						    </label>
						    <input name="course_code" type="text" class="input input-bordered w-full" required />
