        ...
        <div class="lg:min-h-screen">
            <div class="flex items-center justify-center px-5 py-5">
                <div class="w-full mx-auto">
                    <div class="relative mt-1 block text-center">
                        <a href="Home.jsp">
                            <h1 class="font-extrabold text-5xl text-violet-600">
										CourseCraftOnline Registration<span class="text-red-500">.</span>
                            </h1>
                        </a>
                    </div>
                    ...
                    <form class="my-5 max-w-[400px] mx-auto" action="Registration" method="post"
                        ...
                        <input name="log_name" type="text" class="input input-bordered w-full" required />
