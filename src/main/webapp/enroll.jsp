<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
  ...
  <%@page import="java.util.*" %>
   <%@ page import="java.sql.*, java.util.ArrayList" %>
	...
	String course_id_for_enroll = request.getParameter("course_id_for_enroll");
	String course_name_for_enroll = request.getParameter("course_name_for_enroll");
	String teacher_id_for_enroll = request.getParameter("teacher_id_for_enroll");
	String teacher_name_for_enroll = request.getParameter("teacher_name_for_enroll");

	

	session.setAttribute("course_id_for_enroll", course_id_for_enroll);
	session.setAttribute("course_name_for_enroll", course_name_for_enroll);
	session.setAttribute("teacher_id_for_enroll", teacher_id_for_enroll);
	session.setAttribute("teacher_name_for_enroll", teacher_name_for_enroll);
	    ...
	    <div class="bg-white">
	        <div class="lg:min-h-screen">
                ...
                <div class="w-full mx-auto">
                    <div class="relative mt-1 block text-center">
                        <a href="Home.jsp">
                            <h1 class="font-extrabold text-5xl text-violet-600">
										Finalize Enrollment<span class="text-red-500">.</span>
                            </h1>
                        </a>
                    </div>
                    ...
                    <!-- Form -->
                    <form class="my-5 max-w-[400px] mx-auto" action="Enroll" method="post"
                        enctype="application/x-www-form-urlencoded">

                        <!-- Email -->
                        <label class="label">
                            <span class="label-text">If you agree then click submit.</span>
                        </label>
