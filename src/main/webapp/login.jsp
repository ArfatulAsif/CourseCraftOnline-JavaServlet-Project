        ...
        <div class="lg:min-h-screen">
            <div class="flex items-center justify-center px-5 py-5">
                <div class="w-full mx-auto">
                    <div class="relative mt-1 block text-center">
                        <a href="Home.jsp">
                            <h1 class="font-extrabold text-5xl text-violet-600">
										CourseCraftOnline Login<span class="text-red-500">.</span>
                            </h1>
                        </a>
                    </div>
                    ...
                    <h3 class=" max-w-[400px] mx-auto">Don't have an account? <a class="text-purple-500 hover:underline" href="registration.jsp">Register Now</a></h3>
